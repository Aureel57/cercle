...
/* ========== STYLES ========== */
const css=`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;0,9..40,800;1,9..40,400&family=Playfair+Display:wght@400;600;700;800&display=swap');
*{margin:0;padding:0;box-sizing:border-box}html{scroll-behavior:smooth}:root{--p:#5B4EE8;--pd:#3A30D8;--acc:#10B972;--amb:#F59E0B;--dk:#0F0B2B;--tx:#3D3A55;--g:#8F8CA6;--gl:#C4C0D8;--bd:#E6E5EF;--bg:#F8F7FF;--bgw:#EDEAFF;--w:#FFF;--sh:0 1px 2px rgba(0,0,0,.04),0 4px 12px rgba(0,0,0,.03);--shm:0 2px 8px rgba(0,0,0,.06),0 8px 20px rgba(0,0,0,.05);--shl:0 8px 28px rgba(0,0,0,.1),0 2px 4px rgba(0,0,0,.04);--glass:rgba(255,255,255,.75);--blur:blur(20px);--r:16px;--rl:24px;--f:'DM Sans',system-ui,-apple-system,sans-serif;--fd:'Playfair Display',Georgia,serif;--ease:cubic-bezier(.4,0,.2,1)}
...
/* Header */
.hdr{position:sticky;top:0;z-index:100;background:rgba(255,255,255,.92);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border-bottom:1px solid var(--bd);box-shadow:0 2px 20px rgba(91,78,232,.07);transition:box-shadow 0.3s ease;will-change:box-shadow}
...
.lc{width:38px;height:38px;border-radius:12px;background:linear-gradient(135deg,var(--p),var(--pd));display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:18px;font-family:var(--fd);transition:transform 0.3s cubic-bezier(0.34,1.56,0.64,1);will-change:transform;box-shadow:0 4px 12px rgba(91,78,232,.35)}
...
.card{cursor:pointer;position:relative;transition:transform 0.28s cubic-bezier(0.34,1.56,0.64,1),box-shadow 0.28s ease;background:var(--w);border-radius:var(--rl);box-shadow:0 2px 12px rgba(0,0,0,.06),0 6px 24px rgba(0,0,0,.04);overflow:hidden;isolation:isolate;animation:scaleIn 0.4s ease both;will-change:transform,box-shadow;border:1px solid rgba(91,78,232,.06)}
...
.cbo{padding:14px 16px 16px}.cbt{display:flex;justify-content:space-between;align-items:flex-start;gap:8px}.cbn{font-size:15px;font-weight:700;color:var(--dk);line-height:1.35;flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;letter-spacing:-.02em}.cbr{display:flex;align-items:center;gap:3px;font-size:12px;font-weight:700;flex-shrink:0;color:var(--dk)}.cbl{font-size:13px;color:var(--g);margin-top:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:500}.cbc{font-size:11px;color:var(--acc);font-weight:600;margin-top:2px}.cbp{font-size:19px;font-weight:800;color:var(--p);letter-spacing:-.02em}.cbp span{color:var(--g);font-size:12px;font-weight:500}.cbp-row{display:flex;justify-content:space-between;align-items:center;margin-top:10px;flex-wrap:wrap;gap:6px}.cond-badge{font-size:10px;color:var(--p);font-weight:700;background:rgba(91,78,232,.1);padding:4px 9px;border-radius:8px;flex-shrink:0;letter-spacing:.01em}
/* Overlays & Modals */
